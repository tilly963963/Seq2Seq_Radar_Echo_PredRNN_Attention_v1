...
def test_show(model, save_path, model_name,itr):
    ...
    # data_name='202005211700to6'

    # data_name='202005211700to6'
    data_name='202008200400to6'
    ...
    save_path = save_path + 'test_show_itr_{}_{}_Sun_Moon_Lake_dbz1_csi_d1/'.format(itr,data_name)
    from pickle import load
    # places=['Bao_Zhong']
    # date_date=[['2018-08-23 22:10', '2018-08-24 03:59']]
    # test_date=[['2018-08-24 00:10', '2018-08-24 01:00']]
    # test_date=[['2018-03-13 00:10', '2018-03-13 23:59']]
    date_date=[['2020-05-20 04:10', '2020-05-20 04:11']]
    test_date=[['2020-05-20 04:10', '2020-05-20 04:11']]

    # date_date=[['2020-05-21 17:10', '2020-05-21 17:11']]
    # test_date=[['2020-05-21 17:10', '2020-05-21 17:11']]
...
# 2017-04-21 10:00
    ...
    # date_date=[['2020-08-27 00:10', '2020-08-27 00:11']]
    # test_date=[['2020-08-27 00:10', '2020-08-27 00:11']]
    ...
    load_radar_echo_df_path=None#'InterDST_LSTM_L2_H64_finetune_2014to2016_pickday_60_v2/202008260400to6_512x512.pkl'
...
if __name__ == "__main__":                
    ...
    radar_echo_storage_path= 'E:/yu_ting/try/NWP/'#'NWP/'
    load_radar_echo_df_path='InterDST_LSTM_L2_H64_finetune_2014to2016_pickday_60_v2/2017to2018_pick_day.pkl'

    save_path ='InterDST_LSTM_L2_H64_finetune_2014to2016_pickday_60_v2/'
...
#    save_path = 'save_2y3m_0918/'
    ...
    #    model_name ='model_8240110_Sun_Moon_Lake_model_itr30000_test_cost0.0007234304212033749.pkl'
        ...
        model_name = 'model_itr7_test_cost26.142784616221547_ssim0.5924431505587958.pkl'
        # model_name = '.9234249002449655_ssim0.8543377402331324.pkl'
        # test_wrapper(model, save_path, model_name,itr=26,load_model=True)
      
        test_show(model, save_path, model_name,itr=7)
        # for i in range(1,21):
