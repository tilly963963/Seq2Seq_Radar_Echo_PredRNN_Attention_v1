...
parser.add_argument('--sampling_stop_iter', type=int, default=10)#50000)
parser.add_argument('--sampling_start_value', type=float, default=1.0)
parser.add_argument('--sampling_changing_rate', type=float, default=0.2)#0.00002)
...
if __name__ == "__main__":                
    ...
    date_date=[['2014-06-03 01:00', '2014-06-03 04:00'],
    ...
    # test_date = [['2018-08-23 23:00','2018-08-24 01:00']]
    test_date = [['2018-08-23 22:00','2018-08-24 02:00']]
    ...
    load_radar_echo_df_path='InterDST_LSTM_L2_H64_finetune_2014to2016_pickday_d0/2014to2019_pickday_60_test.pkl'

    save_path ='InterDST_LSTM_L2_H64_finetune_2014to2016_pickday_d0/'
    ...
    if not load_radar_echo_df_path:
        ...
        if not os.path.isdir(save_path):
            os.makedirs(save_path)
        radar.saveRadarEchoDataFrame(path=save_path ,load_name_pkl='2014to2019_pickday_60_test')   
...
#    save_path = 'save_2y3m_0918/'
    ...
    pretrained_model ='model_itr8_test_cost19.654044920132474_ssim0.6412362613041935.pkl'#None
