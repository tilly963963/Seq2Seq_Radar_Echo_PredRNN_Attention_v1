...
# 2017-04-21 10:00
    # date_date=[['2020-08-26 04:10', '2020-08-26 04:19']]
    # test_date=[['2020-08-26 04:10', '2020-08-26 04:19']]

    date_date=[['2020-05-21 17:10', '2020-05-21 17:19']]
    test_date=[['2020-05-21 17:10', '2020-05-21 17:19']]
    ...
    load_radar_echo_df_path='InterDST_LSTM_L2_H64_2017to2019_pickday_checkpoint_pretrain/202005211700to6_512x512.pkl'
...
if __name__ == "__main__":                
    ...
    radar_echo_storage_path= 'E:/yu_ting/try/NWP/'#'NWP/'
    load_radar_echo_df_path='InterDST_LSTM_L2_H64_2017to2019_pickday_checkpoint_pretrain/2017to2018_pick_day.pkl'

    save_path ='InterDST_LSTM_L2_H64_2017to2019_pickday_checkpoint_pretrain/'
...
#    save_path = 'save_2y3m_0918/'
    ...
    #    model_name ='model_8240110_Sun_Moon_Lake_model_itr30000_test_cost0.0007234304212033749.pkl'
        ...
        model_name = 'model_itr8_test_cost19.654044920132474_ssim0.6412362613041935.pkl'
