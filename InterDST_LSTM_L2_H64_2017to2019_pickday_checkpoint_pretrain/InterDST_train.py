...
parser.add_argument('--sampling_changing_rate', type=float, default=0.1)#0.00002)
...
#    save_path = 'save_2y3m_0918/'
    ...
    pretrained_model ='model_itr1_test_cost36.334702694268906_ssim0.5424945181764546.pkl'#None
